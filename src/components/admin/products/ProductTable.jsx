...
const AllProduct = () => {
    ...
    const editProduct = async (pId, product, type) => {
        if (type) {
            dispatch({ type: "editProductsModalOpen", product: { ...product, pId: pId } })
        }
    }
                ...
                <table className="table-auto border w-full my-2">
                    ...
                    <tbody>
                        {products && products.length > 0 ? (
                            products.map((item, i) => {
                                return (
                                    <ProductTable product={item} editProduct={(pId, product, type) => editProduct(pId, product, type)}
                            ...
                            <tr>
                                <td colSpan={10} className="text-xl text-center font-semibold p-8">No products found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
...
const ProductTable = ({ product, editProduct, deleteProduct }) => {
    return (
        <>
            <tr>
                ...
                <td className="p-2 text-center">{product.pCategory.pName}</td>
                ...
                <td className="p-2 flex items-center justify-center">
                    <span onClick={(e) => editProduct(product._id, product, true)}
                    ...
                    <span onClick={() => deleteProduct(product._id)}
                        className="cursor-pointer hover:bg-gray-200 rounded-lg p-2 mx-2">
                        <svg
