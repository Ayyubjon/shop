                    ...
                    <form className="w-full" onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className="flex space-x-1 py-4">
                            ...
                            <div className="w-1/2 flex flex-col  space-y-1">
                                ...
                                <select name="category" id="category" value={fData.pCategory} onChange={(e) => setFdata({ ...fData, error: false, success: false, pCategory: e.target.value })} className="px-4 py-2 border focus:outline-none">
                                    <option value="" disabled>Select a Category</option>
                                    {categories?.length > 0 ? categories?.map((elem) => (
                                        <option value={elem._id} key={elem._id} name="category">
                                            {elem.cName}
                                        </option>
                                    )) : ""
                                    }
                        ...
                        <div className="flex space-x-1 py-4">
                            ...
                            <div className="w-1/2 flex flex-col space-y-1">
                                <label htmlFor="quantity">Product offer (%)</label>
                                <input
                                    value={fData.pOffer}
                        ...
                        <div className="flex flex-col space-y-1 w-full pb-4 md:pb-6 mt-4">
                            <button className="rounded-full bg-gray-800 text-gray-100 text-lg font-medium py-2 " type="submit">Create product</button>
                        </div>
                    </form>
                </div>
            </div>
