    ...
    return (
        <>
            <div style={{ boxShadow: "1px 1px 8px 0.2px #aaaaaa" }} id="sidebar" className="hidden md:block sticky top-0 left-0 h-screen md:w-3/12 lg:w-2/12 sidebarShadow bg-white text-gray-600">
                <div onClick={() => navigate("/admin/dashboard")} className={`${location.pathname === "/admin/dashboard" ? "border-r-4 border-gray-800 bg-gray-100" : ""} hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}>
                    <span>
                        <svg
                ...
                <div onClick={() => navigate("/admin/dashboard/categories")} 
                ...
                <hr className="border-b border-gray-200" />
                <div onClick={() => navigate("/admin/dashboard/products")}
